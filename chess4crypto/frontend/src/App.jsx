...
// ✅ ВАШИ АДРЕСА
const C4C_ADDR = '0xaac20575371de01b4d10c4e7566d5453d72d56e7'  // Ваш токен C4C
const CHESS_CONTRACT = '0xCf5E5d01ADd5e2Ba62B2f6747E5CFC43e36D5005'  // Ваш контракт
const PANCAKE_LINK = 'https://pancakeswap.finance/swap?outputCurrency=0xaac20575371de01b4d10c4e7566d5453d72d56e7'

const COLORS = { bg: '#00695c', cardBg: '#004d40', btnBlue: '#1a237e', btnOrange: '#f57c00', text: '#ffffff', textSec: '#b2dfdb', accent: '#ffb74d' }

// ✅ 2 ЯЗЫКА (RU/EN) — можно расширить
const LANG = {
  ru: { 
    t: '♟️ Chess4Crypto', s: 'PvP на токене C4C', g: '👤 Гостевой', c: '🦊 Войти', k: '💰 Купить C4C', p: '👤 Профиль', l: '🚪 Выйти', 
    y: '👤 Вы', b: '🤖 Бот', yt: '♟️ Ваш ход!', bt: '🤖 Бот думает (3с)...', w: '🏆 ПОБЕДА!', x: '😔 Поражение', d: '🤝 Ничья', 
    tp: '⏰ Бот выиграл', tb: '⏰ Вы выиграли', cn: '✅ Подключено', cl: 'Закрыть', cp: '📋 Копировать', cd: '✅ Скопировано!', 
    gt: '💰 Как купить C4C', g1: '1. Перейдите на PancakeSwap и подключите кошелёк в сети BNB.', g2: '2. Обменяйте BNB на токен C4C.', g3: '3. Адрес токена:', 
    ln: '🇷🇺 RU', tc: 'Время:', st: 'Ставка (C4C):', cr: '➕ Создать матч', jn: '🤝 Присоединиться', mv: 'Ходы:', newG: '🔄 В лобби', botG: '🤖 С ботом', 
    select: 'Время', bal: 'Баланс:', games: 'Игры:', noG: 'Нет игр', myG: 'Мои игры', join: 'Войти', copy: 'Ссылка скопирована!', invite: '🔗 Приглашение', 
    dep: '💰 Внести', claim: '🏆 Забрать', approve: '✅ Разрешить', waiting: '⏳ Ожидание соперника...', playing: '♟️ Игра идёт', sync: '🔄 Синхронизация...', 
    review: '🔍 Просмотр', live: '▶️ В реальном времени', prev: '⏪ Назад', next: '⏩ Вперёд', pot: 'Банк игры:', payout: 'Выплата:', refund: 'Возврат', 
    drawRefund: '🤝 Ничья — ставки возвращены', winnerGets: '🏆 Победитель забирает 98% банка', needDep: 'Нужно внести', toJoin: 'C4C для присоединения', 
    yourStake: 'Ваша ставка:', oppStake: 'Ставка соперника:', totalPot: 'Общий банк:', setTime: 'Выберите время:', approveTx: '1️⃣ Разрешаем контракт тратить C4C...', 
    depositTx: '2️⃣ Переводим ставку в пул игры...', confirmingTx: '⏳ Ожидание подтверждения блокчейна...', successDep: '✅ Депозит подтверждён! Игра создана.', 
    successJoin: '✅ Депозит внесён! Игра начинается.', errTx: '❌ Ошибка: ', errBal: '❌ Недостаточно C4C', claimBtn: '💰 Забрать выигрыш', 
    victoryTitle: '🏆 Победа!', defeatTitle: '😔 Поражение', drawTitle: '🤝 Ничья', noMetaMask: '⚠️ Установите MetaMask/TrustWallet', 
    playerProfile: '👤 Профиль', avatar: '🖼️ Аватар', name: '👤 Имя', bio: '📝 О себе', website: '🌐 Сайт', social: '🔗 Соцсеть', save: '💾 Сохранить', 
    availableGames: '🎮 Доступные игры', guestInfo: '⏱️ Гостевой режим: бесплатно с ботом. Выберите время для игры.', 
    guestInstructions: '📖 Гостевой режим:\n• Выберите время партии выше.\n• Нажмите "🤖 С ботом".\n• Играйте бесплатно без блокчейна.', 
    grokInstructions: `📖 Создание игры на C4C:\n1️⃣ Нажмите "➕ Создать матч".\n2️⃣ Выберите ставку и время.\n3️⃣ Подтвердите в кошельке ДВЕ транзакции:\n   • Approve: разрешить тратить C4C\n   • Create/Deposit: перевести ставку в контракт ${CHESS_CONTRACT.slice(0,10)}...${CHESS_CONTRACT.slice(-4)}\n4️⃣ Дождитесь подтверждения (~15 сек).\n5️⃣ Скопируйте ссылку и отправьте сопернику.\n6️⃣ Когда соперник внесёт депозит — игра начнётся!\n7️⃣ Победитель забирает 98% банка (2% комиссия платформы).`, 
    txCancelled: '⚠️ Транзакция отменена', step1: 'Шаг 1/2: Разрешение', step2: 'Шаг 2/2: Депозит', clickToCopy: '📋 Нажмите для копирования', 
    checkBalance: '🔍 Проверить баланс контракта', profileSaved: '✅ Профиль сохранён!', profileError: '❌ Ошибка сохранения профиля', pvpMode: '👥 PvP режим', botMode: '🤖 Режим с ботом' 
  },
  en: { 
    t: '♟️ Chess4Crypto', s: 'C4C PvP Betting', g: '👤 Guest', c: '🦊 Connect', k: '💰 Buy C4C', p: '👤 Profile', l: '🚪 Logout', 
    y: '👤 You', b: '🤖 Bot', yt: '♟️ Your turn!', bt: '🤖 Bot thinks (3s)...', w: '🏆 YOU WIN!', x: '😔 Lost', d: '🤝 Draw', 
    tp: '⏰ Bot wins', tb: '⏰ You win', cn: '✅ Connected', cl: 'Close', cp: '📋 Copy', cd: '✅ Copied!', 
    gt: '💰 Buy C4C', g1: '1. Go to PancakeSwap, connect BNB wallet.', g2: '2. Swap BNB for C4C token.', g3: '3. Token address:', 
    ln: '🇬🇧 EN', tc: 'Time:', st: 'Stake (C4C):', cr: '➕ Create Match', jn: '🤝 Join', mv: 'Moves:', newG: '🔄 Lobby', botG: '🤖 Vs Bot', 
    select: 'Time', bal: 'Balance:', games: 'Games:', noG: 'No games', myG: 'My Games', join: 'Join', copy: 'Copied!', invite: '🔗 Invite', 
    dep: '💰 Deposit', claim: '🏆 Claim Win', approve: '✅ Approve', waiting: '⏳ Waiting opponent...', playing: '♟️ Game in progress', sync: '🔄 Syncing...', 
    review: '🔍 Review', live: '▶️ Live', prev: '⏪ Prev', next: '⏩ Next', pot: 'Game Pot:', payout: 'Payout:', refund: 'Refund', 
    drawRefund: '🤝 Draw — stakes refunded', winnerGets: '🏆 Winner takes 98% of pot', needDep: 'Need to deposit', toJoin: 'C4C to join', 
    yourStake: 'Your stake:', oppStake: 'Opponent stake:', totalPot: 'Total pot:', setTime: 'Select Time:', approveTx: '1️⃣ Approve C4C...', 
    depositTx: '2️⃣ Deposit to pool...', confirmingTx: '⏳ Waiting for blockchain confirmation...', successDep: '✅ Deposit confirmed! Game created.', 
    successJoin: '✅ Deposit paid! Game started.', errTx: '❌ Error: ', errBal: '❌ Insufficient C4C', claimBtn: '💰 Claim Winnings', 
    victoryTitle: '🏆 Victory!', defeatTitle: '😔 Defeat', drawTitle: '🤝 Draw', noMetaMask: '⚠️ Install MetaMask/TrustWallet', 
    playerProfile: '👤 Profile', avatar: '🖼️ Avatar', name: '👤 Name', bio: '📝 Bio', website: '🌐 Website', social: '🔗 Social', save: '💾 Save', 
    availableGames: '🎮 Available Games', guestInfo: '⏱️ Guest mode: free vs bot. Select game time.', 
    guestInstructions: '📖 Guest Mode:\n• Select time control above.\n• Click "🤖 Vs Bot".\n• Play for free, no blockchain.', 
    grokInstructions: `📖 Create C4C game:\n1️⃣ Click "➕ Create Match".\n2️⃣ Select stake & time.\n3️⃣ Confirm TWO transactions in wallet:\n   • Approve: allow spending C4C\n   • Create/Deposit: send stake to contract ${CHESS_CONTRACT.slice(0,10)}...${CHESS_CONTRACT.slice(-4)}\n4️⃣ Wait for confirmation (~15s).\n5️⃣ Copy link & send to opponent.\n6️⃣ When opponent deposits — game starts!\n7️⃣ Winner takes 98% of pot (2% platform fee).`, 
    txCancelled: '⚠️ Transaction cancelled', step1: 'Step 1/2: Approve', step2: 'Step 2/2: Deposit', clickToCopy: '📋 Tap to copy', 
    checkBalance: '🔍 Check contract balance', profileSaved: '✅ Profile saved!', profileError: '❌ Failed to save profile', pvpMode: '👥 PvP Mode', botMode: '🤖 Bot Mode' 
  }
}
...
// ✅ ABI ВАШЕГО КОНТРАКТА (ChessBetToken.sol)
const CHESS_ABI = [
...
export default function App() {
  ...
  // ✅ WAGMI HOOKS — ВКЛЮЧАЯ useConnect
  const { address, isConnected } = useAccount()
  const { disconnect } = useDisconnect()
  const { connectors, connect, isPending: isConnecting } = useConnect()  // ✅ НОВЫЙ ХУК ДЛЯ ПОДКЛЮЧЕНИЯ
  const { writeContractAsync } = useWriteContract()
  const { depositReceipt, isSuccess: depositConfirmed } = useWaitForTransactionReceipt({ hash: txHash })

  // ✅ READ CONTRACTS — БАЛАНС
  const {  userC4CBalance, refetch: refetchUserBalance, isLoading: balanceLoading } = useReadContract({
    address: C4C_ADDR,
    abi: ERC20_ABI,
  ...
  const {  contractC4CBalance } = useReadContract({
    address: C4C_ADDR,
    abi: ERC20_ABI,
    functionName: 'balanceOf',
    args: [CHESS_CONTRACT],
  ...
  const langNext = () => setLang(l => ({ ru: 'en', en: 'ru' })[l])
  ...
  // ✅ ПОДКЛЮЧЕНИЕ КОШЕЛЬКА ЧЕРЕЗ useConnect
  const connectWallet = async () => { 
    try { 
      // Подключаемся через первый доступный коннектор (обычно MetaMask)
  ...
  const handleCreateMatch = async () => {
    ...
    try {
      ...
      console.log('✅ CreateGame TX:', createTx)
      ...
      console.log('✅ DepositStake TX:', depositTx)
      setTxHash(depositTx)
      
      // 🔹 ШАГ 4: Запись в базу + обновление состояния
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.bg, color: COLORS.text, fontFamily: 'system-ui', padding: '1rem', display: 'flex', justifyContent: 'center', overflowX: 'hidden' }}>
      {view === 'menu' && <div style={{ maxWidth: '400px', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
        ...
        {/* ✅ КНОПКА ПОДКЛЮЧЕНИЯ ЧЕРЕЗ useConnect */}
        {isConnected ? (
          <button onClick={() => { disconnect(); setView('menu') }} disabled={loadingTx} style={BtnStyle('#b71c1c', loadingTx)}>{t('l')}</button>
        ) : (
          <button onClick={connectWallet} disabled={loadingTx || isConnecting} style={BtnStyle(COLORS.btnOrange, loadingTx || isConnecting)}>
            {isConnecting ? '⏳...' : t('c')}
          </button>
        )}
      ...
      {view === 'profile' && <div style={{ maxWidth: '600px', width: '100%', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        {profileTab === 'lobby' && <div style={{ background: COLORS.cardBg, padding: '1rem', borderRadius: '12px' }}><h3 style={{ color: COLORS.accent, margin: '0 0 0.8rem' }}>{t('availableGames')}</h3>{availableGames.length > 0 ? availableGames.map(g => { const totalPot = (g.stake || 0) * ((g.creatorPaid ? 1 : 0) + (g.challengerPaid ? 1 : 0)); return (<div key={g.id} style={{ background: 'rgba(0,0,0,0.2)', padding: '0.8rem', borderRadius: '8px', marginBottom: '0.8rem' }}><div style={{ display: 'flex', justifyContent: 'space-between' }}><b>ID: ...{g.id.slice(-6)}</b><span style={{ color: g.status === 'playing' ? COLORS.accent : COLORS.textSec }}>{g.status}</span></div><div style={{ fontSize: '0.8rem', color: COLORS.textSec, margin: '0.5rem 0' }}>{t('st')}: {g.stake} | ⏱️ {g.time_limit}мин | {t('totalPot')}: {totalPot}C4C</div>{!g.challengerPaid && g.creator !== address && <button onClick={() => { setPendingJoin({ id: g.id, stake: g.stake, time: g.time_limit }); handleJoinMatch() }} disabled={loadingTx} style={{ ...BtnStyle('#10b981', loadingTx), marginTop: '0.5rem' }}>{t('jn')} ({g.stake} C4C)</button>}</div>) }) : <p style={{ color: COLORS.textSec }}>{t('noG')}</p>}</div>}

        {pendingJoin && <div style={{ background: 'linear-gradient(135deg,#1e293b,#334155)', padding: '1.5rem', borderRadius: '12px', textAlign: 'center', border: `2px solid ${COLORS.accent}` }}><h3 style={{ color: COLORS.accent, margin: '0 0 0.5rem' }}>{t('invite')}</h3><p>{t('needDep')} <b style={{ color: COLORS.accent }}>{pendingJoin.stake.toLocaleString()} C4C</b></p><p style={{ color: COLORS.textSec, fontSize: '0.9rem', marginBottom: '1rem' }}>⏱️ {pendingJoin.time} мин</p><button onClick={handleJoinMatch} disabled={loadingTx} style={BtnStyle('#10b981', loadingTx)}>{`🤝 ${t('jn')}`}</button></div>}
      ...
      {grok && <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.9)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }} onClick={() => setGrok(false)}><div style={{ background: COLORS.cardBg, padding: '1.5rem', borderRadius: '16px', maxWidth: '360px' }} onClick={e => e.stopPropagation()}><h3 style={{ color: COLORS.accent }}>{t('gt')}</h3><ol style={{ color: COLORS.textSec, margin: '1rem 0', paddingLeft: '1.2rem' }}><li style={{ marginBottom: '0.5rem' }}>{t('g1')}<br /><a href={PANCAKE_LINK} target="_blank" rel="noopener" style={{ color: '#60a5fa', wordBreak: 'break-all' }}>{PANCAKE_LINK}</a></li><li style={{ marginBottom: '0.5rem' }}>{t('g2')}</li><li>{t('g3')}<br /><code style={{ background: '#00332e', padding: '0.3rem', borderRadius: '4px', display: 'block', margin: '0.3rem 0', fontSize: '0.8rem' }}>{C4C_ADDR}</code><button onClick={copyAddr} style={{ ...BtnStyle(COLORS.btnBlue, loadingTx), marginTop: '0.5rem', padding: '8px' }}>{cop ? t('cd') : t('cp')}</button></li></ol><a href={PANCAKE_LINK} target="_blank" style={{ display: 'block', background: '#f57c00', color: '#000', padding: '0.6rem', borderRadius: '8px', textAlign: 'center', textDecoration: 'none', marginTop: '0.5rem' }}>🥞 PancakeSwap</a><button onClick={() => setGrok(false)} style={{ ...BtnStyle('#334155'), marginTop: '0.5rem' }}>{t('cl')}</button></div></div>}
