...
// 🏁 Claim — ✅ ПОБЕДИТЕЛЬ ЗАБИРАЕТ ВСЁ / НИЧЬЯ → ВОЗВРАТ
const handleClaim=(isDraw)=>{
  if(!gameId){setMsg('⚠️ Game not finished');return}
  claimWrite({address:CHESS_CONTRACT,abi:CHESS_ABI,functionName:'finish',args:[gameId,address||'0x0000000000000000000000000000000000000000',isDraw]},{
    onSuccess:()=>{
