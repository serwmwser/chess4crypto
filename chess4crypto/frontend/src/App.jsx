...
export default function App() {
  ...
  const handleJoinMatch = async () => {
    ...
    const currentWalletBalance = balanceData != null ? Number(formatUnits(balanceData, 18)) : 0
    if (currentWalletBalance < pendingJoin.stake) { setMsg(t('errBal')); return }
