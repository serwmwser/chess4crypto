...
export default function App() {
  ...
  // 🎯 Функции матчмейкинга и приглашений
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'profile':
        return <Profile onNavigate={(tab) => setActiveTab(tab)} />;
      case 'chat':
        return <div style={{ padding: '2rem', textAlign: 'center' }}><h2>💬 Общий чат</h2><p style={{ color: '#94a3b8' }}>Доступен во время онлайн-партии</p></div>;
      default:
        return <div style={{ padding: '2rem', textAlign: 'center' }}><h2>🚧 В разработке</h2></div>;
    }
  };
