...
// 🌍 7 ЯЗЫКОВ
const LANG = {
  ru: { t:'♟️ Chess4Crypto', s:'Web3 шахматы с крипто-ставками', g:'👤 Гостевой вход', c:'🦊 Подключить кошелёк', k:'💰 Купить GROK', p:'👤 Профиль', l:'🚪 Выйти', y:'👤 Вы', b:'🤖 Бот', yt:'♟️ Ваш ход!', bt:'🤖 Бот думает...', w:'🏆 ПОБЕДА!', x:'😔 Поражение', d:'🤝 Ничья', tp:'⏰ Бот выиграл', tb:'⏰ Вы выиграли', cn:'✅ Кошелёк подключён!', nw:'⚠️ Подключение доступно только с расширением', cl:'Закрыть', cp:'📋 Скопировать', cd:'✅ Скопировано!', gt:'💰 Как купить GROK', g1:'1. Перейди на сайт по ссылке и подключи свой крипто-кошелёк в сети BNB, на котором есть BNB для комиссии.', g2:'2. Купи монету GROK на любую сумму.', g3:'3. Добавь GROK в свой кошелёк для отображения. Адрес контракта монеты:', ln:'🇷🇺 RU', th:'🎨 Тема доски', tm:{c:'🏛️ Классика',w:'🪵 Дерево',n:'💜 Неон',o:'🌊 Океан',s:'🌅 Закат',m:'⚪ Минимал'} },
  en: { t:'♟️ Chess4Crypto', s:'Web3 Chess with Crypto Stakes', g:'👤 Guest Mode', c:'🦊 Connect Wallet', k:'💰 Buy GROK', p:'👤 Profile', l:'🚪 Logout', y:'👤 You', b:'🤖 Bot', yt:'♟️ Your turn!', bt:'🤖 Bot thinking...', w:'🏆 YOU WIN!', x:'😔 You lost', d:'🤝 Draw', tp:'⏰ Bot wins', tb:'⏰ You win', cn:'✅ Wallet connected!', nw:'⚠️ Connection requires extension', cl:'Close', cp:'📋 Copy', cd:'✅ Copied!', gt:'💰 How to Buy GROK', g1:'1. Go to the link and connect your crypto wallet on BNB Chain with BNB for gas fees.', g2:'2. Buy GROK token for any amount.', g3:'3. Add GROK to your wallet to display it. Contract address:', ln:'🇬🇧 EN', th:'🎨 Board Theme', tm:{c:'🏛️ Classic',w:'🪵 Wood',n:'💜 Neon',o:'🌊 Ocean',s:'🌅 Sunset',m:'⚪ Minimal'} },
  de: { t:'♟️ Chess4Crypto', s:'Web3-Schach mit Krypto', g:'👤 Gast', c:'🦊 Wallet', k:'💰 GROK', p:'👤 Profil', l:'🚪 Exit', y:'👤 Du', b:'🤖 Bot', yt:'♟️ Dein Zug!', bt:'🤖 Bot denkt...', w:'🏆 GEWINN!', x:'😔 Verloren', d:'🤝 Remis', tp:'⏰ Bot gewinnt', tb:'⏰ Du gewinnst', cn:'✅ Verbunden', nw:'⚠️ Nur mit Extension', cl:'Schließen', cp:'📋 Kopieren', cd:'✅ Kopiert', gt:'💰 GROK kaufen', g1:'1. Gehe zum Link und verbinde Wallet auf BNB Chain mit BNB.', g2:'2. Kaufe GROK-Token.', g3:'3. Füge Adresse zum Wallet hinzu:', ln:'🇩🇪 DE', th:'🎨 Design', tm:{c:'🏛️ Klassisch',w:'🪵 Holz',n:'💜 Neon',o:'🌊 Ozean',s:'🌅 Sonnenuntergang',m:'⚪ Minimal'} },
  fr: { t:'♟️ Chess4Crypto', s:'Échecs Web3 crypto', g:'👤 Invité', c:'🦊 Wallet', k:'💰 GROK', p:'👤 Profil', l:'🚪 Quitter', y:'👤 Vous', b:'🤖 Bot', yt:'♟️ À vous!', bt:'🤖 Bot réfléchit...', w:'🏆 GAGNÉ!', x:'😔 Perdu', d:'🤝 Nulle', tp:'⏰ Bot gagne', tb:'⏰ Vous gagnez', cn:'✅ Connecté', nw:'⚠️ Extension requise', cl:'Fermer', cp:'📋 Copier', cd:'✅ Copié', gt:'💰 Acheter GROK', g1:'1. Allez sur le lien et connectez wallet sur BNB Chain avec BNB.', g2:'2. Achetez GROK.', g3:'3. Ajoutez l\'adresse au wallet:', ln:'🇫🇷 FR', th:'🎨 Thème', tm:{c:'🏛️ Classique',w:'🪵 Bois',n:'💜 Néon',o:'🌊 Océan',s:'🌅 Coucher',m:'⚪ Minimal'} },
  es: { t:'♟️ Chess4Crypto', s:'Ajedrez Web3 crypto', g:'👤 Invitado', c:'🦊 Wallet', k:'💰 GROK', p:'👤 Perfil', l:'🚪 Salir', y:'👤 Tú', b:'🤖 Bot', yt:'♟️ ¡Tu turno!', bt:'🤖 Bot piensa...', w:'🏆 ¡GANASTE!', x:'😔 Perdiste', d:'🤝 Empate', tp:'⏰ Bot gana', tb:'⏰ Ganas tú', cn:'✅ Conectado', nw:'⚠️ Requiere extensión', cl:'Cerrar', cp:'📋 Copiar', cd:'✅ Copiado', gt:'💰 Comprar GROK', g1:'1. Ve al enlace y conecta wallet en BNB Chain con BNB.', g2:'2. Compra GROK.', g3:'3. Añade la dirección al wallet:', ln:'🇪🇸 ES', th:'🎨 Tema', tm:{c:'🏛️ Clásico',w:'🪵 Madera',n:'💜 Neón',o:'🌊 Océano',s:'🌅 Atardecer',m:'⚪ Minimal'} },
  zh: { t:'♟️ Chess4Crypto', s:'Web3国际象棋', g:'👤 访客', c:'🦊 钱包', k:'💰 GROK', p:'👤 资料', l:'🚪 退出', y:'👤 你', b:'🤖 机器人', yt:'♟️ 轮到你!', bt:'🤖 思考中...', w:'🏆 你赢了!', x:'😔 你输了', d:'🤝 平局', tp:'⏰ 机器人赢', tb:'⏰ 你赢了', cn:'✅ 已连接', nw:'⚠️ 需要扩展程序', cl:'关闭', cp:'📋 复制', cd:'✅ 已复制', gt:'💰 购买GROK', g1:'1. 点击链接并在BNB链上连接钱包（需要BNB）。', g2:'2. 购买GROK代币。', g3:'3. 将地址添加到钱包:', ln:'🇨🇳 中文', th:'🎨 主题', tm:{c:'🏛️ 经典',w:'🪵 木质',n:'💜 霓虹',o:'🌊 海洋',s:'🌅 日落',m:'⚪ 简约'} },
  hi: { t:'♟️ Chess4Crypto', s:'Web3 शतरंज', g:'👤 अतिथि', c:'🦊 वॉलेट', k:'💰 GROK', p:'👤 प्रोफ़ाइल', l:'🚪 बाहर', y:'👤 आप', b:'🤖 बॉट', yt:'♟️ आपकी बारी!', bt:'🤖 सोच रहा...', w:'🏆 आप जीते!', x:'😔 आप हारे', d:'🤝 ड्रॉ', tp:'⏰ बॉट जीता', tb:'⏰ आप जीते', cn:'✅ कनेक्ट', nw:'⚠️ एक्सटेंशन चाहिए', cl:'बंद', cp:'📋 कॉपी', cd:'✅ कॉपी', gt:'💰 GROK खरीदें', g1:'1. लिंक पर जाएं और BNB Chain पर वॉलेट कनेक्ट करें।', g2:'2. GROK खरीदें।', g3:'3. एड्रेस वॉलेट में जोड़ें:', ln:'🇮🇳 हिंदी', th:'🎨 थीम', tm:{c:'🏛️ क्लासिक',w:'🪵 लकड़ी',n:'💜 नियॉन',o:'🌊 महासागर',s:'🌅 सूर्यास्त',m:'⚪ मिनिमल'} }
}
...
export default function App() {
  ...
  // ✅ Кошелёк: ПРОСТО показывает сообщение (никаких вызовов ethereum!)
  const connect = () => { setMsg(t('nw')) }
