...
// 🌍 7 ЯЗЫКОВ (полный перевод)
const L={
ru:{t:'♟️ Chess4Crypto',s:'Шахматы с крипто-ставками',g:'👤 Гостевой',c:'🦊 Подключить',k:'💰 GROK',p:'👤 Профиль',l:'🚪 Выйти',y:'👤 Вы',b:'🤖 Бот',yt:'♟️ Ваш ход!',bt:'🤖 Бот (3с)...',w:'🏆 ПОБЕДА!',x:'😔 Поражение',d:'🤝 Ничья',tp:'⏰ Бот выиграл',tb:'⏰ Вы выиграли',cn:'✅ Подключено',cl:'Закрыть',cp:'📋 Копировать',cd:'✅ Скопировано!',gt:'💰 Как купить GROK',g1:'1. Перейди по ссылке и подключи крипто-кошелёк в сети BNB (нужен BNB для комиссии).',g2:'2. Купи монету GROK на любую сумму.',g3:'3. Добавь адрес в кошелёк для отображения:',ln:'🇷🇺 RU',th:'🎨 Тема',tm:{c:'🏛️ Классика',w:'🪵 Дерево',n:'💜 Неон',o:'🌊 Океан',s:'🌅 Закат',m:'⚪ Минимал'}},
en:{t:'♟️ Chess4Crypto',s:'Chess with Crypto Stakes',g:'👤 Guest',c:'🦊 Connect',k:'💰 GROK',p:'👤 Profile',l:'🚪 Logout',y:'👤 You',b:'🤖 Bot',yt:'♟️ Your turn!',bt:'🤖 Bot (3s)...',w:'🏆 YOU WIN!',x:'😔 Lost',d:'🤝 Draw',tp:'⏰ Bot wins',tb:'⏰ You win',cn:'✅ Connected',cl:'Close',cp:'📋 Copy',cd:'✅ Copied!',gt:'💰 How to Buy GROK',g1:'1. Follow link and connect BNB Chain wallet (need BNB for gas).',g2:'2. Buy GROK token for any amount.',g3:'3. Add contract to wallet to display:',ln:'🇬🇧 EN',th:'🎨 Theme',tm:{c:'🏛️ Classic',w:'🪵 Wood',n:'💜 Neon',o:'🌊 Ocean',s:'🌅 Sunset',m:'⚪ Minimal'}},
de:{t:'♟️ Chess4Crypto',s:'Schach mit Krypto',g:'👤 Gast',c:'🦊 Verbinden',k:'💰 GROK',p:'👤 Profil',l:'🚪 Exit',y:'👤 Du',b:'🤖 Bot',yt:'♟️ Dein Zug!',bt:'🤖 Bot (3s)...',w:'🏆 GEWINN!',x:'😔 Verloren',d:'🤝 Remis',tp:'⏰ Bot gewinnt',tb:'⏰ Du gewinnst',cn:'✅ Verbunden',cl:'Schließen',cp:'📋 Kopieren',cd:'✅ Kopiert',gt:'💰 GROK kaufen',g1:'1. Link öffnen und BNB Wallet verbinden (BNB für Gebühren).',g2:'2. GROK-Token kaufen.',g3:'3. Adresse im Wallet hinzufügen:',ln:'🇩🇪 DE',th:'🎨 Design',tm:{c:'🏛️ Klassisch',w:'🪵 Holz',n:'💜 Neon',o:'🌊 Ozean',s:'🌅 Sonnenuntergang',m:'⚪ Minimal'}},
fr:{t:'♟️ Chess4Crypto',s:'Échecs avec crypto',g:'👤 Invité',c:'🦊 Connecter',k:'💰 GROK',p:'👤 Profil',l:'🚪 Quitter',y:'👤 Vous',b:'🤖 Bot',yt:'♟️ À vous!',bt:'🤖 Bot (3s)...',w:'🏆 GAGNÉ!',x:'😔 Perdu',d:'🤝 Nulle',tp:'⏰ Bot gagne',tb:'⏰ Vous gagnez',cn:'✅ Connecté',cl:'Fermer',cp:'📋 Copier',cd:'✅ Copié',gt:'💰 Acheter GROK',g1:'1. Suivre lien et connecter wallet BNB (BNB pour frais).',g2:'2. Acheter GROK.',g3:'3. Ajouter adresse au wallet:',ln:'🇫🇷 FR',th:'🎨 Thème',tm:{c:'🏛️ Classique',w:'🪵 Bois',n:'💜 Néon',o:'🌊 Océan',s:'🌅 Coucher',m:'⚪ Minimal'}},
es:{t:'♟️ Chess4Crypto',s:'Ajedrez con crypto',g:'👤 Invitado',c:'🦊 Conectar',k:'💰 GROK',p:'👤 Perfil',l:'🚪 Salir',y:'👤 Tú',b:'🤖 Bot',yt:'♟️ ¡Tu turno!',bt:'🤖 Bot (3s)...',w:'🏆 ¡GANASTE!',x:'😔 Perdiste',d:'🤝 Empate',tp:'⏰ Bot gana',tb:'⏰ Ganas tú',cn:'✅ Conectado',cl:'Cerrar',cp:'📋 Copiar',cd:'✅ Copiado',gt:'💰 Comprar GROK',g1:'1. Ir al enlace y conectar wallet BNB (BNB para comisiones).',g2:'2. Comprar GROK.',g3:'3. Añadir dirección al wallet:',ln:'🇪🇸 ES',th:'🎨 Tema',tm:{c:'🏛️ Clásico',w:'🪵 Madera',n:'💜 Neón',o:'🌊 Océano',s:'🌅 Atardecer',m:'⚪ Minimal'}},
zh:{t:'♟️ Chess4Crypto',s:'国际象棋与加密货币',g:'👤 访客',c:'🦊 连接',k:'💰 GROK',p:'👤 资料',l:'🚪 退出',y:'👤 你',b:'🤖 机器人',yt:'♟️ 轮到你!',bt:'🤖 机器人 (3s)...',w:'🏆 你赢了!',x:'😔 你输了',d:'🤝 平局',tp:'⏰ 机器人赢',tb:'⏰ 你赢了',cn:'✅ 已连接',cl:'关闭',cp:'📋 复制',cd:'✅ 已复制',gt:'💰 购买GROK',g1:'1. 点击链接连接BNB链钱包（需BNB支付手续费）。',g2:'2. 购买GROK代币。',g3:'3. 将地址添加到钱包:',ln:'🇨🇳 中文',th:'🎨 主题',tm:{c:'🏛️ 经典',w:'🪵 木质',n:'💜 霓虹',o:'🌊 海洋',s:'🌅 日落',m:'⚪ 简约'}},
hi:{t:'♟️ Chess4Crypto',s:'शतरंज क्रिप्टो के साथ',g:'👤 अतिथि',c:'🦊 कनेक्ट',k:'💰 GROK',p:'👤 प्रोफ़ाइल',l:'🚪 बाहर',y:'👤 आप',b:'🤖 बॉट',yt:'♟️ आपकी बारी!',bt:'🤖 बॉट (3s)...',w:'🏆 आप जीते!',x:'😔 आप हारे',d:'🤝 ड्रॉ',tp:'⏰ बॉट जीता',tb:'⏰ आप जीते',cn:'✅ कनेक्ट',cl:'बंद',cp:'📋 कॉपी',cd:'✅ कॉपी',gt:'💰 GROK खरीदें',g1:'1. लिंक पर जाएं और BNB वॉलेट कनेक्ट करें (गैस के लिए BNB चाहिए)।',g2:'2. GROK खरीदें।',g3:'3. एड्रेस वॉलेट में जोड़ें:',ln:'🇮🇳 हिंदी',th:'🎨 थीम',tm:{c:'🏛️ क्लासिक',w:'🪵 लकड़ी',n:'💜 नियॉन',o:'🌊 महासागर',s:'🌅 सूर्यास्त',m:'⚪ मिनिमल'}}
}

// 🎨 6 ТЕМ ДОСОК
const TM={c:{l:'#eeeed2',d:'#769656',n:'🏛️ Classic'},w:{l:'#f0d9b5',d:'#b58863',n:'🪵 Wood'},n:{l:'#1a1a2e',d:'#16213e',n:'💜 Neon'},o:{l:'#e0f7fa',d:'#006064',n:'🌊 Ocean'},s:{l:'#fff3e0',d:'#e65100',n:'🌅 Sunset'},m:{l:'#e0e0e0',d:'#757575',n:'⚪ Minimal'}}
...
useEffect(()=>{if(tr.current)clearInterval(tr.current);if(!ta||go)return;tr.current=setInterval(()=>{if(ta==='p')setPT(v=>{if(v<=1){clearInterval(tr.current);setGo(true);setWin('b');setMsg(t('tp'));return 0}return v-1});else setBT(v=>{if(v<=1){clearInterval(tr.current);setGo(true);setWin('p');setMsg(t('tb'));return 0}return v-1})},1000);return()=>clearInterval(tr.current)},[ta,go,t])

// 🔘 КНОПКИ
// ✅ 1. Гостевой вход
const guest=()=>{setMsg(t('g'));setGo(false);setWin(null);setPT(900);setBT(900);start()}

// ✅ 3. Подключить кошелёк: АКТИВНАЯ кнопка → сразу в профиль
const connectWallet=()=>{setMsg(t('cn'));setView('profile')}

// ✅ 2. Купить GROK: только в профиле
const buyGrok=()=>setGrok(true)

// ✅ 4. Переключение языка (7 вариантов)
const langNext=()=>setLang(l=>({ru:'en',en:'de',de:'fr',fr:'es',es:'zh',zh:'hi',hi:'ru'})[l])

// Копирование адреса
const copyC=()=>{if(navigator.clipboard){navigator.clipboard.writeText(GC);setCop(true);setTimeout(()=>setCop(false),2000)}}
