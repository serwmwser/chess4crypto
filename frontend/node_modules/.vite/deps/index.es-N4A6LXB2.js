...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_3) try {
      if (f6 = 1, y8 && (t = op[0] & 2 ? y8["return"] : op[0] ? y8["throw"] || ((t = y8["return"]) && t.call(y8), 0) : y8.next) && !(t = t.call(y8, op[1])).done) return t;
      if (y8 = 0, t) op = [op[0] & 2, t.value];
      switch (op[0]) {
        case 0:
        case 1:
          t = op;
...
(function(e2) {
  (function() {
    ...
    }, A4 = [{ name: "keccak", padding: S5, bits: F, createMethod: Rt2 }, { name: "sha3", padding: I3, bits: F, createMethod: Rt2 }, { name: "shake", padding: w5, bits: U4, createMethod: Yt3 }, { name: "cshake", padding: y8, bits: U4, createMethod: Y }, { name: "kmac", padding: y8, bits: U4, createMethod: Vt3 }], f6 = {}, a4 = [], c6 = 0; c6 < A4.length; ++c6) for (var d4 = A4[c6], g5 = d4.bits, x3 = 0; x3 < g5.length; ++x3) {
    ...
    s3.prototype.update = function(u4) {
      ...
      for (u4 = u4 >> 8, _3 = u4 & 255; _3 > 0; ) R2.unshift(_3), u4 = u4 >> 8, _3 = u4 & 255, ++B3;
      ...
      for (var u4 = this.blockCount, E7 = this.s, _3 = this.outputBlocks, B3 = this.extraBytes, R2 = 0, T4 = 0, P2 = "", O5; T4 < _3; ) {
        for (R2 = 0; R2 < u4 && T4 < _3; ++R2, ++T4) O5 = E7[R2], P2 += m4[O5 >> 4 & 15] + m4[O5 & 15] + m4[O5 >> 12 & 15] + m4[O5 >> 8 & 15] + m4[O5 >> 20 & 15] + m4[O5 >> 16 & 15] + m4[O5 >> 28 & 15] + m4[O5 >> 24 & 15];
        T4 % u4 === 0 && (k3(E7), R2 = 0);
      }
      ...
      for (var Ct4 = new Uint32Array(O5); T4 < _3; ) {
        for (R2 = 0; R2 < u4 && T4 < _3; ++R2, ++T4) Ct4[T4] = E7[R2];
        T4 % u4 === 0 && k3(E7);
      }
      ...
      for (var u4 = this.blockCount, E7 = this.s, _3 = this.outputBlocks, B3 = this.extraBytes, R2 = 0, T4 = 0, P2 = [], O5, Ct4; T4 < _3; ) {
        for (R2 = 0; R2 < u4 && T4 < _3; ++R2, ++T4) O5 = T4 << 2, Ct4 = E7[R2], P2[O5] = Ct4 & 255, P2[O5 + 1] = Ct4 >> 8 & 255, P2[O5 + 2] = Ct4 >> 16 & 255, P2[O5 + 3] = Ct4 >> 24 & 255;
        T4 % u4 === 0 && k3(E7);
      }
    ...
    Object.keys(i4).forEach((b5) => {
      ...
      try {
        if (m4 instanceof Uint8Array) {
          let w5 = "";
          for (let y8 = 0; y8 < m4.length; y8++) w5 += kn[m4[y8] >> 4], w5 += kn[m4[y8] & 15];
          n5.push(b5 + "=Uint8Array(0x" + w5 + ")");
        } else n5.push(b5 + "=" + JSON.stringify(m4));
      } catch {
...
(function(e2) {
  (function(t, r3) {
    function i4(A4, f6) {
      if (!A4) throw new Error(f6 || "Assertion failed");
    }
    function n5(A4, f6) {
      A4.super_ = f6;
      var a4 = function() {
    ...
    o5.isBN = function(f6) {
      ...
      if (typeof f6 == "number") return this._initNumber(f6, a4, c6);
      if (typeof f6 == "object") return this._initArray(f6, a4, c6);
      ...
      if (i4(typeof f6.length == "number"), f6.length <= 0) return this.words = [0], this.length = 1, this;
      this.length = Math.ceil(f6.length / 3), this.words = new Array(this.length);
      for (var d4 = 0; d4 < this.length; d4++) this.words[d4] = 0;
      var g5, x3, M4 = 0;
      if (c6 === "be") for (d4 = f6.length - 1, g5 = 0; d4 >= 0; d4 -= 3) x3 = f6[d4] | f6[d4 - 1] << 8 | f6[d4 - 2] << 16, this.words[g5] |= x3 << M4 & 67108863, this.words[g5 + 1] = x3 >>> 26 - M4 & 67108863, M4 += 24, M4 >= 26 && (M4 -= 26, g5++);
      else if (c6 === "le") for (d4 = 0, g5 = 0; d4 < f6.length; d4 += 3) x3 = f6[d4] | f6[d4 + 1] << 8 | f6[d4 + 2] << 16, this.words[g5] |= x3 << M4 & 67108863, this.words[g5 + 1] = x3 >>> 26 - M4 & 67108863, M4 += 24, M4 >= 26 && (M4 -= 26, g5++);
      return this._strip();
    };
    function p5(A4, f6) {
    ...
    o5.prototype._parseHex = function(f6, a4, c6) {
      ...
      for (var d4 = 0; d4 < this.length; d4++) this.words[d4] = 0;
      var g5 = 0, x3 = 0, M4;
      if (c6 === "be") for (d4 = f6.length - 1; d4 >= a4; d4 -= 2) M4 = b5(f6, a4, d4) << g5, this.words[x3] |= M4 & 67108863, g5 >= 18 ? (g5 -= 18, x3 += 1, this.words[x3] |= M4 >>> 26) : g5 += 8;
      else {
        var l5 = f6.length - a4;
        for (d4 = l5 % 2 === 0 ? a4 + 1 : a4; d4 < f6.length; d4 += 2) M4 = b5(f6, a4, d4) << g5, this.words[x3] |= M4 & 67108863, g5 >= 18 ? (g5 -= 18, x3 += 1, this.words[x3] |= M4 >>> 26) : g5 += 8;
      }
      this._strip();
    };
    ...
    o5.prototype._parseBase = function(f6, a4, c6) {
      ...
      d4--, g5 = g5 / a4 | 0;
      for (var x3 = f6.length - c6, M4 = x3 % d4, l5 = Math.min(x3, x3 - M4) + c6, s3 = 0, v5 = c6; v5 < l5; v5 += d4) s3 = m4(f6, v5, v5 + d4, a4), this.imuln(g5), this.words[0] + s3 < 67108864 ? this.words[0] += s3 : this._iaddn(s3);
      if (M4 !== 0) {
        var k3 = 1;
        for (s3 = m4(f6, v5, f6.length, a4), v5 = 0; v5 < M4; v5++) k3 *= a4;
      ...
      for (var a4 = 0; a4 < this.length; a4++) f6.words[a4] = this.words[a4];
    ...
    o5.prototype.toArrayLike = function(f6, a4, c6) {
      ...
      if (c6 < f6.length) for (f6[c6++] = d4; c6 < f6.length; ) f6[c6++] = 0;
      ...
      if (c6 >= 0) for (f6[c6--] = d4; c6 >= 0; ) f6[c6--] = 0;
    ...
    o5.prototype.zeroBits = function() {
      ...
      for (var a4 = 0; a4 < f6.length; a4++) this.words[a4] = this.words[a4] | f6.words[a4];
      return this._strip();
      ...
      for (var c6 = 0; c6 < a4.length; c6++) this.words[c6] = this.words[c6] & f6.words[c6];
      ...
      var a4;
      if (this.negative !== 0 && f6.negative === 0) return this.negative = 0, a4 = this.isub(f6), this.negative ^= 1, this._normSign();
      if (this.negative === 0 && f6.negative !== 0) return f6.negative = 0, a4 = this.isub(f6), f6.negative = 1, a4._normSign();
      var c6, d4;
    ...
    o5.prototype.mulTo = function(f6, a4) {
      ...
      if (i4(typeof f6 == "number"), i4(f6 < 67108864), f6 < 0) return this.iaddn(-f6);
      ...
      if (i4(!f6.isZero()), this.isZero()) return { div: new o5(0), mod: new o5(0) };
      var d4, g5, x3;
      ...
      for (var c6 = (1 << 26) % f6, d4 = 0, g5 = this.length - 1; g5 >= 0; g5--) d4 = (c6 * d4 + (this.words[g5] | 0)) % f6;
      return a4 ? -d4 : d4;
    ...
    n5(Pt2, z6), Pt2.prototype.split = function(f6, a4) {
      for (var c6 = 4194303, d4 = Math.min(f6.length, 9), g5 = 0; g5 < d4; g5++) a4.words[g5] = f6.words[g5];
    ...
    n5(Yt3, z6), Yt3.prototype.imulK = function(f6) {
      ...
      if (H[f6]) return H[f6];
      var a4;
      if (f6 === "k256") a4 = new Pt2();
      else if (f6 === "p224") a4 = new W2();
      else if (f6 === "p192") a4 = new Rt2();
      else if (f6 === "p25519") a4 = new Yt3();
    ...
    function Y(A4) {
      ...
      } else i4(A4.gtn(1), "modulus must be greater than 1"), this.m = A4, this.prime = null;
    }
    Y.prototype._verify1 = function(f6) {
      ...
      if (a4.cmpn(1) === 0) return f6.clone();
      var c6 = 4, d4 = new Array(1 << c6);
      d4[0] = new o5(1).toRed(this), d4[1] = f6;
      for (var g5 = 2; g5 < d4.length; g5++) d4[g5] = this.mul(d4[g5 - 1], f6);
    ...
    n5(Vt3, Y), Vt3.prototype.convertTo = function(f6) {
      ...
      if (f6.isZero() || a4.isZero()) return f6.words[0] = 0, f6.length = 1, f6;
      ...
      if (f6.isZero() || a4.isZero()) return new o5(0)._forceRed(this);
...
var fe = cr(function(e2, t) {
  ...
  function i4(h5, p5) {
    ...
    var b5 = [];
    if (typeof h5 != "string") {
      for (var m4 = 0; m4 < h5.length; m4++) b5[m4] = h5[m4] | 0;
      return b5;
    }
    if (p5 === "hex") {
      h5 = h5.replace(/[^a-z0-9]+/ig, ""), h5.length % 2 !== 0 && (h5 = "0" + h5);
      for (var m4 = 0; m4 < h5.length; m4 += 2) b5.push(parseInt(h5[m4] + h5[m4 + 1], 16));
    } else for (var m4 = 0; m4 < h5.length; m4++) {
...
Ce.prototype.point = function() {
  ...
  for (p5 = 0; p5 < n5.length; p5 += i4.step) {
    b5 = 0;
    for (var m4 = p5 + i4.step - 1; m4 >= p5; m4--) b5 = (b5 << 1) + n5[m4];
    h5.push(b5);
  }
  for (var w5 = this.jpoint(null, null, null), y8 = this.jpoint(null, null, null), S5 = o5; S5 > 0; S5--) {
    for (p5 = 0; p5 < h5.length; p5++) b5 = h5[p5], b5 === S5 ? y8 = y8.mixedAdd(i4.points[p5]) : b5 === -S5 && (y8 = y8.mixedAdd(i4.points[p5].neg()));
    w5 = w5.add(y8);
  }
  return w5.toP();
  ...
  for (var o5 = n5.points, h5 = Ur(r3, i4, this._bitLength), p5 = this.jpoint(null, null, null), b5 = h5.length - 1; b5 >= 0; b5--) {
    for (var m4 = 0; b5 >= 0 && h5[b5] === 0; b5--) m4++;
    if (b5 >= 0 && m4++, p5 = p5.dblp(m4), b5 < 0) break;
    var w5 = h5[b5];
  ...
  for (w5 = m4; w5 >= 0; w5--) {
    for (var Pt2 = 0; w5 >= 0; ) {
      var W2 = true;
      for (y8 = 0; y8 < n5; y8++) z6[y8] = b5[y8][w5] | 0, z6[y8] !== 0 && (W2 = false);
      if (!W2) break;
      Pt2++, w5--;
    }
...
Zt.prototype._getEndomorphism = function(t) {
  ...
  for (var r3 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i4 = t, n5 = this.n.clone(), o5 = new K(1), h5 = new K(0), p5 = new K(0), b5 = new K(1), m4, w5, y8, S5, I3, N11, C5, F = 0, U4, J2; i4.cmpn(0) !== 0; ) {
    ...
    if (!y8 && U4.cmp(r3) < 0) m4 = C5.neg(), w5 = o5, y8 = U4.neg(), S5 = J2;
  ...
  for (var w5 = this._wnafMulAdd(1, n5, o5, h5 * 2, i4), y8 = 0; y8 < h5 * 2; y8++) n5[y8] = null, o5[y8] = null;
  return w5;
};
...
Di(Tt, Ze.BasePoint), Zt.prototype.jpoint = function(t, r3, i4) {
  ...
  if (b5.cmpn(0) === 0) return m4.cmpn(0) !== 0 ? this.curve.jpoint(null, null, null) : this.dbl();
...
$t.prototype.keyPair = function(t) {
  ...
  if (h5.cmp(this.curve.p.umod(this.curve.n)) >= 0 && m4) throw new Error("Unable to find sencond key candinate");
...
function Hi2(o5, e2) {
  ...
  function g5(u4) {
    ...
    for (var A4 = x3 - T4; A4 !== x3 && w5[A4] === 0; ) A4++;
    for (var G = h5.repeat(p5); A4 < x3; ++A4) G += o5.charAt(w5[A4]);
    return G;
  }
  function m4(u4) {
    ...
    if (u4[p5] !== " ") {
      ...
      if (u4[p5] !== " ") {
        ...
        for (var A4 = new Uint8Array(T4 + (P2 - _3)), G = T4; _3 !== P2; ) A4[G++] = x3[_3++];
        return A4;
      }
    }
  }
...
var rs2 = (o5, e2, t) => {
  ...
  let r3 = "", n5 = 0, a4 = 0;
  for (let h5 = 0; h5 < o5.length; ++h5) for (a4 = a4 << 8 | o5[h5], n5 += 8; n5 > t; ) n5 -= t, r3 += e2[s3 & a4 >> n5];
  if (n5 && (r3 += e2[s3 & a4 << t - n5]), i4) for (; r3.length * t & 7; ) r3 += "=";
  return r3;
};
...
function Me(o5, e2, t) {
  e2 = e2 || [], t = t || 0;
  for (var i4 = t; o5 >= Gs2; ) e2[t++] = o5 & 255 | Be2, o5 /= 128;
  ...
  constructor(e2, t) {
    super(e2, t), this.relayer = e2, this.logger = t, this.events = new import_events7.EventEmitter(), this.name = ht, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time4.toMiliseconds)(import_time4.ONE_MINUTE), this.failedPublishTimeout = (0, import_time4.toMiliseconds)(import_time4.ONE_SECOND), this.needsTransportRestart = false, this.publish = async (i4, s3, r3) => {
      ...
      try {
        ...
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(D4), (n5 = r3 == null ? void 0 : r3.internal) != null && n5.throwOnFailedPublish) throw D4;
  ...
  constructor(e2, t) {
    super(e2, t), this.projectId = e2, this.logger = t, this.name = ee, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i4) => {
      ...
      await Promise.race([new Promise((r3) => {
        ...
        if (n5) return this.iframe = n5, this.onInit(), r3();
...
var y6 = (R2, n5) => {
  for (var t in n5 || (n5 = {})) Bt2.call(n5, t) && We3(R2, t, n5[t]);
  if (Be3) for (var t of Be3(n5)) Wt3.call(n5, t) && We3(R2, t, n5[t]);
  return R2;
};
  ...
  constructor(n5) {
    super(n5), this.name = Fe2, this.events = new import_events8.default(), this.initialized = false, this.requestQueue = { state: D2.idle, queue: [] }, this.sessionRequestQueue = { state: D2.idle, queue: [] }, this.requestQueueDelay = import_time5.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.init = async () => {
      ...
      const S5 = g5 && g5 > f4.wc_sessionAuthenticate.req.ttl ? g5 : f4.wc_sessionAuthenticate.req.ttl, N11 = { authPayload: { type: a4 ?? "caip122", chains: e2, statement: s3, aud: i4, domain: r3, version: "1", nonce: o5, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: c6, nbf: h5, resources: d4 }, requester: { publicKey: E7, metadata: this.client.metadata }, expiryTimestamp: d0(S5) }, P2 = { eip155: { chains: e2, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...p5])], events: ["chainChanged", "accountsChanged"] } }, v5 = { requiredNamespaces: {}, optionalNamespaces: P2, relays: [{ protocol: "irn" }], proposer: { publicKey: E7, metadata: this.client.metadata }, expiryTimestamp: d0(f4.wc_sessionPropose.req.ttl) }, { done: B3, resolve: Ie, reject: ae2 } = a0(S5, "Request expired"), W2 = async ({ error: T4, session: _3 }) => {
        if (this.events.off(v0("session_request", K3), ce2), T4) ae2(T4);
        else if (_3) {
      ...
      for (const w5 of s3) {
        ...
        for (const N11 of O5) p5.push(`${N11}:${S5}`);
      }
      ...
      try {
        ...
        if (this.events.listenerCount(w5) === 0) throw new Error(`emitting ${w5} without any listeners 997`);
...
(function(A4, u4) {
  (function() {
    ...
    function Cs3(h5, g5) {
      for (var d4 = -1, C5 = h5 == null ? 0 : h5.length; ++d4 < C5; ) if (!g5(h5[d4], d4, h5)) return false;
      return true;
    }
    function jn2(h5, g5) {
    ...
    function Dr3(h5, g5, d4) {
      for (var C5 = -1, S5 = h5 == null ? 0 : h5.length; ++C5 < S5; ) if (d4(g5, h5[C5])) return true;
      return false;
    }
    function G(h5, g5) {
      for (var d4 = -1, C5 = h5 == null ? 0 : h5.length, S5 = Array(C5); ++d4 < C5; ) S5[d4] = g5(h5[d4], d4, h5);
      return S5;
    }
    function nt2(h5, g5) {
      for (var d4 = -1, C5 = g5.length, S5 = h5.length; ++d4 < C5; ) h5[S5 + d4] = g5[d4];
      return h5;
    }
    function Nr3(h5, g5, d4, C5) {
      var S5 = -1, U4 = h5 == null ? 0 : h5.length;
      for (C5 && U4 && (d4 = h5[++S5]); ++S5 < U4; ) d4 = g5(d4, h5[S5], S5, h5);
      return d4;
    }
    function tf2(h5, g5, d4, C5) {
      var S5 = h5 == null ? 0 : h5.length;
      for (C5 && S5 && (d4 = h5[--S5]); S5--; ) d4 = g5(d4, h5[S5], S5, h5);
      return d4;
    }
    function Hr2(h5, g5) {
      for (var d4 = -1, C5 = h5 == null ? 0 : h5.length; ++d4 < C5; ) if (g5(h5[d4], d4, h5)) return true;
      return false;
    }
    var ef2 = $r2("length");
    function rf2(h5) {
    ...
    function Is3(h5, g5, d4) {
      ...
      return d4(h5, function(S5, U4, X3) {
        if (g5(S5, U4, X3)) return C5 = U4, false;
      }), C5;
    }
    function ye3(h5, g5, d4, C5) {
      for (var S5 = h5.length, U4 = d4 + (C5 ? 1 : -1); C5 ? U4-- : ++U4 < S5; ) if (g5(h5[U4], U4, h5)) return U4;
      return -1;
    }
    ...
    function uf2(h5, g5, d4, C5) {
      for (var S5 = d4 - 1, U4 = h5.length; ++S5 < U4; ) if (C5(h5[S5], g5)) return S5;
      return -1;
    }
    function xs3(h5) {
      return h5 !== h5;
    ...
    function Fr3(h5, g5) {
      for (var d4 = -1, C5 = Array(h5); ++d4 < h5; ) C5[d4] = g5(d4);
      return C5;
    }
    function of2(h5, g5) {
    ...
    function ff2(h5, g5) {
      for (var d4 = h5.length, C5 = 0; d4--; ) h5[d4] === g5 && ++C5;
      return C5;
    }
    ...
    function _f2(h5, g5, d4) {
      for (var C5 = d4 - 1, S5 = h5.length; ++C5 < S5; ) if (h5[C5] === g5) return C5;
      return -1;
    }
    function mf2(h5, g5, d4) {
      for (var C5 = d4 + 1; C5--; ) if (h5[C5] === g5) return C5;
      return C5;
    }
    function Dt3(h5) {
    ...
    var wf2 = Ur3(Jo2);
    function Pf2(h5) {
      for (var g5 = br2.lastIndex = 0; br2.test(h5); ) ++g5;
      return g5;
    }
    function Af2(h5) {
      return h5.match(br2) || [];
    ...
    var If2 = function h5(g5) {
      ...
      function a4(n5) {
        if (Y(n5) && !O5(n5) && !(n5 instanceof H)) {
          if (n5 instanceof Pn2) return n5;
          if (F.call(n5, "__wrapped__")) return Mu2(n5);
        }
        return new Pn2(n5);
      }
      ...
      function Kf2() {
        ...
        } else n5 = this.clone(), n5.__dir__ *= -1;
        return n5;
      }
      function Yf2() {
        ...
        if (!e2 || !r3 && s3 == l5 && I3 == l5) return fu2(n5, this.__actions__);
        var E7 = [];
        n: for (; l5-- && P2 < I3; ) {
          v5 += t;
      ...
      function gt2(n5) {
        var t = -1, e2 = n5 == null ? 0 : n5.length;
        for (this.__data__ = new Gn2(); ++t < e2; ) this.add(n5[t]);
      }
      function oc(n5) {
      ...
      function dc(n5, t) {
        ...
        if (e2 instanceof Bn) {
          var r3 = e2.__data__;
          if (!te2 || r3.length < w5 - 1) return r3.push([n5, t]), this.size = ++e2.size, this;
      ...
      function Ms3(n5, t) {
        ...
        for (var v5 in n5) (t || F.call(n5, v5)) && !(f6 && (v5 == "length" || s3 && (v5 == "offset" || v5 == "parent") || o5 && (v5 == "buffer" || v5 == "byteLength" || v5 == "byteOffset") || Zn2(v5, l5))) && c6.push(v5);
        return c6;
      }
      function qs3(n5) {
        var t = n5.length;
      ...
      function Be4(n5, t) {
        for (var e2 = n5.length; e2--; ) if (bn2(n5[e2][0], t)) return e2;
        return -1;
      }
      ...
      function Zr(n5, t) {
        for (var e2 = -1, r3 = t.length, s3 = d4(r3), o5 = n5 == null; ++e2 < r3; ) s3[e2] = o5 ? i4 : Si2(n5, t[e2]);
        return s3;
      }
      ...
      function An(n5, t, e2, r3, s3, o5) {
        ...
        if (e2 && (f6 = s3 ? e2(n5, r3, s3, o5) : e2(n5)), f6 !== i4) return f6;
        if (!K3(n5)) return n5;
        var _3 = O5(n5);
        if (_3) {
          if (f6 = uh2(n5), !c6) return un2(n5, f6);
        } else {
          var m4 = tn2(n5), P2 = m4 == Pe3 || m4 == zi2;
          if (at2(n5)) return lu2(n5, c6);
          if (m4 == qn2 || m4 == Ot3 || P2 && !s3) {
            if (f6 = l5 || P2 ? {} : Tu(n5), !c6) return l5 ? Xc(n5, mc(f6, n5)) : Jc(n5, Bs3(f6, n5));
          } else {
            if (!q3[m4]) return s3 ? n5 : {};
            f6 = ah2(n5, m4, c6);
          }
        }
        o5 || (o5 = new Rn());
      ...
      function Gs3(n5, t, e2) {
        var r3 = e2.length;
        if (n5 == null) return !r3;
        for (n5 = M4(n5); r3--; ) {
          var s3 = e2[r3], o5 = t[s3], f6 = n5[s3];
          if (f6 === i4 && !(s3 in n5) || !o5(f6)) return false;
        }
        return true;
      }
      function zs3(n5, t, e2) {
        if (typeof n5 != "function") throw new wn2(D4);
        return le3(function() {
          n5.apply(i4, e2);
        }, t);
      }
      ...
      function Ge3(n5, t, e2) {
        for (var r3 = -1, s3 = n5.length; ++r3 < s3; ) {
          ...
          if (f6 != null && (c6 === i4 ? f6 === f6 && !pn(f6) : e2(f6, c6))) var c6 = f6, l5 = o5;
        }
        return l5;
      }
      function Ac(n5, t, e2, r3) {
        var s3 = n5.length;
        for (e2 = R2(e2), e2 < 0 && (e2 = -e2 > s3 ? 0 : s3 + e2), r3 = r3 === i4 || r3 > s3 ? s3 : R2(r3), r3 < 0 && (r3 += s3), r3 = e2 > r3 ? 0 : oa2(r3); e2 < r3; ) n5[e2++] = t;
        return n5;
      }
      function Ys3(n5, t) {
        var e2 = [];
      ...
      function _t2(n5, t) {
        t = st2(t, n5);
        for (var e2 = 0, r3 = t.length; n5 != null && e2 < r3; ) n5 = n5[Wn2(t[e2++])];
      ...
      function Oc(n5, t, e2, r3, s3, o5) {
        ...
        if (P2 && !_3) return o5 || (o5 = new Rn()), f6 || Bt3(n5) ? Ou2(n5, t, e2, r3, s3, o5) : th2(n5, t, l5, e2, r3, s3, o5);
        if (!(e2 & Et2)) {
      ...
      function kr2(n5, t, e2, r3) {
        ...
        if (n5 == null) return !o5;
        for (n5 = M4(n5); s3--; ) {
          var c6 = e2[s3];
          if (f6 && c6[2] ? c6[1] !== n5[c6[0]] : !(c6[0] in n5)) return false;
        }
        for (; ++s3 < o5; ) {
          c6 = e2[s3];
          var l5 = c6[0], v5 = n5[l5], _3 = c6[1];
          if (f6 && c6[2]) {
            if (v5 === i4 && !(l5 in n5)) return false;
          } else {
            var m4 = new Rn();
            if (r3) var P2 = r3(v5, _3, l5, n5, t, m4);
            if (!(P2 === i4 ? oe3(_3, v5, Et2 | ve2, r3, m4) : P2)) return false;
          }
        }
        return true;
      }
      function Qs3(n5) {
        if (!K3(n5) || hh2(n5)) return false;
      ...
      function jr2(n5) {
        if (!he2(n5)) return Hf2(n5);
        var t = [];
        for (var e2 in M4(n5)) F.call(n5, e2) && e2 != "constructor" && t.push(e2);
        return t;
      }
      function Dc(n5) {
        if (!K3(n5)) return gh(n5);
        var t = he2(n5), e2 = [];
        for (var r3 in n5) r3 == "constructor" && (t || !F.call(n5, r3)) || e2.push(r3);
        return e2;
      }
      function ni(n5, t) {
        return n5 < t;
      ...
      function Ke3(n5, t, e2, r3, s3) {
        n5 !== t && Jr2(t, function(o5, f6) {
          if (s3 || (s3 = new Rn()), K3(o5)) Nc(n5, t, f6, e2, Ke3, r3, s3);
          else {
      ...
      function tu2(n5, t) {
        var e2 = n5.length;
        if (e2) return t += t < 0 ? e2 : 0, Zn2(t, e2) ? n5[t] : i4;
      }
      ...
      function ti(n5, t, e2, r3) {
        ...
        for (n5 === t && (t = un2(t)), e2 && (c6 = G(n5, hn2(e2))); ++o5 < f6; ) for (var l5 = 0, v5 = t[o5], _3 = e2 ? e2(v5) : v5; (l5 = s3(c6, _3, l5, r3)) > -1; ) c6 !== n5 && He3.call(c6, l5, 1), He3.call(n5, l5, 1);
        return n5;
      }
      function iu2(n5, t) {
      ...
      function Uc(n5, t, e2, r3) {
        for (var s3 = -1, o5 = Q4(Ue3((t - n5) / (e2 || 1)), 0), f6 = d4(o5); o5--; ) f6[r3 ? o5 : ++s3] = n5, n5 += e2;
        return f6;
      }
      function ri(n5, t) {
        var e2 = "";
        if (!n5 || t < 1 || t > kn2) return e2;
        do
      ...
      function fe3(n5, t, e2, r3) {
        ...
        for (var s3 = -1, o5 = t.length, f6 = o5 - 1, c6 = n5; c6 != null && ++s3 < o5; ) {
          ...
          if (l5 === "__proto__" || l5 === "constructor" || l5 === "prototype") return n5;
          if (s3 != f6) {
            var _3 = c6[l5];
      ...
      function Cn(n5, t, e2) {
        ...
        for (var o5 = d4(s3); ++r3 < s3; ) o5[r3] = n5[r3 + t];
        return o5;
      }
      function Bc(n5, t) {
        var e2;
      ...
      function ii(n5, t, e2, r3) {
        ...
        for (var f6 = t !== t, c6 = t === null, l5 = pn(t), v5 = t === i4; s3 < o5; ) {
          ...
          if (f6) var y8 = r3 || E7;
          else v5 ? y8 = E7 && (r3 || P2) : c6 ? y8 = E7 && P2 && (r3 || !I3) : l5 ? y8 = E7 && P2 && !I3 && (r3 || !T4) : I3 || T4 ? y8 = false : y8 = r3 ? m4 <= t : m4 < t;
          y8 ? s3 = _3 + 1 : o5 = _3;
        }
        return nn2(o5, qa2);
      }
      ...
      function it2(n5, t, e2) {
        ...
        n: for (; ++r3 < o5; ) {
          ...
          if (_3 = e2 || _3 !== 0 ? _3 : 0, f6 && m4 === m4) {
            for (var P2 = l5.length; P2--; ) if (l5[P2] === m4) continue n;
            t && l5.push(m4), c6.push(_3);
          } else s3(l5, m4, e2) || (l5 !== c6 && l5.push(m4), c6.push(_3));
        }
        return c6;
      }
      function si(n5, t) {
      ...
      function ui(n5, t, e2) {
        var r3 = n5.length;
        if (r3 < 2) return r3 ? it2(n5[0]) : [];
        for (var s3 = -1, o5 = d4(r3); ++s3 < r3; ) for (var f6 = n5[s3], c6 = -1; ++c6 < r3; ) c6 != s3 && (o5[s3] = ue3(o5[s3] || f6, n5[c6], t, e2));
      ...
      function du2(n5, t) {
        if (n5 !== t) {
          ...
          if (!c6 && !v5 && !o5 && n5 > t || o5 && f6 && l5 && !c6 && !v5 || r3 && f6 && l5 || !e2 && l5 || !s3) return 1;
          if (!r3 && !o5 && !v5 && n5 < t || v5 && e2 && s3 && !r3 && !o5 || c6 && e2 && s3 || !f6 && s3 || !l5) return -1;
        }
        return 0;
      }
      function Zc(n5, t, e2) {
      ...
      function gu2(n5, t, e2, r3) {
        for (var s3 = -1, o5 = n5.length, f6 = e2.length, c6 = -1, l5 = t.length, v5 = Q4(o5 - f6, 0), _3 = d4(l5 + v5), m4 = !r3; ++c6 < l5; ) _3[c6] = t[c6];
        for (; ++s3 < f6; ) (m4 || s3 < o5) && (_3[e2[s3]] = n5[s3]);
        for (; v5--; ) _3[c6++] = n5[s3++];
        return _3;
      }
      function vu2(n5, t, e2, r3) {
        for (var s3 = -1, o5 = n5.length, f6 = -1, c6 = e2.length, l5 = -1, v5 = t.length, _3 = Q4(o5 - c6, 0), m4 = d4(_3 + v5), P2 = !r3; ++s3 < _3; ) m4[s3] = n5[s3];
        for (var I3 = s3; ++l5 < v5; ) m4[I3 + l5] = t[l5];
        for (; ++f6 < c6; ) (P2 || s3 < o5) && (m4[I3 + e2[f6]] = n5[s3++]);
        return m4;
      }
      function un2(n5, t) {
        var e2 = -1, r3 = n5.length;
        for (t || (t = d4(r3)); ++e2 < r3; ) t[e2] = n5[e2];
        return t;
      }
      ...
      function Vc(n5, t, e2) {
        var r3 = ce2(n5);
        function s3() {
          for (var o5 = arguments.length, f6 = d4(o5), c6 = o5, l5 = qt3(s3); c6--; ) f6[c6] = arguments[c6];
          var v5 = o5 < 3 && f6[0] !== l5 && f6[o5 - 1] !== l5 ? [] : tt2(f6, l5);
          if (o5 -= v5.length, o5 < e2) return xu2(n5, t, Xe4, s3.placeholder, i4, f6, v5, i4, i4, e2 - o5);
      ...
      function Au2(n5) {
        return Yn2(function(t) {
          ...
          for (n5 && t.reverse(); r3--; ) {
            ...
            if (s3 && !f6 && je3(o5) == "wrapper") var f6 = new Pn2([], true);
          }
          ...
          return function() {
            ...
            if (f6 && v5.length == 1 && O5(_3)) return f6.plant(_3).value();
            for (var m4 = 0, P2 = e2 ? t[m4].apply(this, v5) : _3; ++m4 < e2; ) P2 = t[m4].call(this, P2);
            return P2;
          };
        });
      }
      function Xe4(n5, t, e2, r3, s3, o5, f6, c6, l5, v5) {
        ...
        function y8() {
          for (var N11 = arguments.length, $3 = d4(N11), dn2 = N11; dn2--; ) $3[dn2] = arguments[dn2];
          if (I3) var sn2 = qt3(y8), gn = ff2($3, sn2);
      ...
      function kc(n5, t, e2, r3) {
        ...
        function f6() {
          for (var c6 = -1, l5 = arguments.length, v5 = -1, _3 = r3.length, m4 = d4(_3 + l5), P2 = this && this !== k3 && this instanceof f6 ? o5 : n5; ++v5 < _3; ) m4[v5] = r3[v5];
          for (; l5--; ) m4[v5++] = arguments[++c6];
      ...
      function Kn2(n5, t, e2, r3, s3, o5, f6, c6) {
        var l5 = t & ct2;
        if (!l5 && typeof n5 != "function") throw new wn2(D4);
        ...
        if (P2 && dh(I3, P2), n5 = I3[0], t = I3[1], e2 = I3[2], r3 = I3[3], s3 = I3[4], c6 = I3[9] = I3[9] === i4 ? l5 ? 0 : n5.length : Q4(I3[9] - v5, 0), !c6 && t & (Dn2 | yt2) && (t &= ~(Dn2 | yt2)), !t || t == vn) var E7 = Qc(n5, t, e2);
        else t == Dn2 || t == yt2 ? E7 = Vc(n5, t, c6) : (t == Nn2 || t == (vn | Nn2)) && !s3.length ? E7 = kc(n5, t, e2, r3) : E7 = Xe4.apply(i4, I3);
        var T4 = P2 ? su : $u2;
        ...
        for (o5.set(n5, t), o5.set(t, n5); ++m4 < c6; ) {
          ...
          if (I3) {
            if (!Hr2(t, function(N11, $3) {
              if (!jt3(I3, $3) && (E7 === N11 || s3(E7, N11, e2, r3, o5))) return I3.push($3);
            })) {
              P2 = false;
              break;
            }
      ...
      function th2(n5, t, e2, r3, s3, o5, f6) {
        switch (e2) {
          case Rt2:
            if (n5.byteLength != t.byteLength || n5.byteOffset != t.byteOffset) return false;
          ...
          case Sn2:
            var l5 = r3 & Et2;
            if (c6 || (c6 = Se3), n5.size != t.size && !l5) return false;
            var v5 = f6.get(n5);
            if (v5) return v5 == t;
            r3 |= ve2, f6.set(n5, t);
          ...
          case Ae2:
            if (ie4) return ie4.call(n5) == ie4.call(t);
        }
        return false;
      }
      function eh2(n5, t, e2, r3, s3, o5) {
        var f6 = e2 & Et2, c6 = li(n5), l5 = c6.length, v5 = li(t), _3 = v5.length;
        if (l5 != _3 && !f6) return false;
        for (var m4 = l5; m4--; ) {
          var P2 = c6[m4];
          if (!(f6 ? P2 in t : F.call(t, P2))) return false;
        }
        var I3 = o5.get(n5), E7 = o5.get(t);
        if (I3 && E7) return I3 == t && E7 == n5;
        var T4 = true;
        o5.set(n5, t), o5.set(t, n5);
        for (var y8 = f6; ++m4 < l5; ) {
          P2 = c6[m4];
          var N11 = n5[P2], $3 = t[P2];
          if (r3) var dn2 = f6 ? r3($3, N11, P2, t, n5, o5) : r3(N11, $3, P2, n5, t, o5);
      ...
      function je3(n5) {
        for (var t = n5.name + "", e2 = Ut3[t], r3 = F.call(Ut3, t) ? e2.length : 0; r3--; ) {
          ...
          if (o5 == null || o5 == n5) return s3.name;
        }
        return t;
      }
      function qt3(n5) {
      ...
      var vi2 = Gr2 ? function(n5) {
        ...
        for (var t = []; n5; ) nt2(t, vi2(n5)), n5 = Ne(n5);
        return t;
      } : Ni2, tn2 = en2;
...
`);
      ...
      function gh(n5) {
        var t = [];
        if (n5 != null) for (var e2 in M4(n5)) t.push(e2);
        return t;
      }
      function vh(n5) {
        return Te.call(n5);
      ...
      function Nu2(n5, t, e2) {
        return t = Q4(t === i4 ? n5.length - 1 : t, 0), function() {
          for (var r3 = arguments, s3 = -1, o5 = Q4(r3.length - t, 0), f6 = d4(o5); ++s3 < o5; ) f6[s3] = r3[t + s3];
          s3 = -1;
          for (var c6 = d4(t + 1); ++s3 < t; ) c6[s3] = r3[s3];
      ...
      function wi2(n5, t) {
        if (!(t === "constructor" && typeof n5[t] == "function") && t != "__proto__") return n5[t];
      }
      ...
      function Wn2(n5) {
        if (typeof n5 == "string" || pn(n5)) return n5;
        var t = n5 + "";
        return t == "0" && 1 / n5 == -ht2 ? "-0" : t;
      }
      function wt2(n5) {
      ...
      function Mu2(n5) {
        if (n5 instanceof H) return n5.clone();
      ...
      function wh(n5, t, e2) {
        ...
        if (!r3 || t < 1) return [];
        for (var s3 = 0, o5 = 0, f6 = d4(Ue3(r3 / t)); s3 < r3; ) f6[o5++] = Cn(n5, s3, s3 += t);
        return f6;
      }
      function Ph(n5) {
      ...
      function Ah() {
        ...
        if (!n5) return [];
        for (var t = d4(n5 - 1), e2 = arguments[0], r3 = n5; r3--; ) t[r3 - 1] = arguments[r3];
      ...
      function Xh(n5, t) {
        ...
        if (e2) {
          var r3 = Ye3(n5, t);
          if (r3 < e2 && bn2(n5[r3], t)) return r3;
        }
        return -1;
      }
      function Qh(n5, t) {
      ...
      function Xl(n5) {
        if (n5 == null) return 0;
        if (an2(n5)) return or4(n5) ? Dt3(n5) : n5.length;
        var t = tn2(n5);
      ...
      function kl(n5, t) {
        ...
        return n5 = R2(n5), function() {
          if (--n5 < 1) return t.apply(this, arguments);
        };
      }
      ...
      function ta2(n5, t, e2) {
        ...
        function gn() {
          ...
          if (r3 = arguments, s3 = this, l5 = J2, Tn2) {
            if (c6 === i4) return E7(l5);
            if (m4) return hu(c6), c6 = le3(N11, t), I3(l5);
          }
      ...
      function sr3(n5, t) {
        if (typeof n5 != "function" || t != null && typeof t != "function") throw new wn2(D4);
        var e2 = function() {
          var r3 = arguments, s3 = t ? t.apply(this, r3) : r3[0], o5 = e2.cache;
          if (o5.has(s3)) return o5.get(s3);
      ...
      var rp = Gc(function(n5, t) {
        ...
        return L6(function(r3) {
          for (var s3 = -1, o5 = nn2(r3.length, e2); ++s3 < o5; ) r3[s3] = t[s3].call(this, r3[s3]);
      ...
      function Cp(n5) {
        ...
        if (an2(n5) && (O5(n5) || typeof n5 == "string" || typeof n5.splice == "function" || at2(n5) || Bt3(n5) || Pt2(n5))) return !n5.length;
        var t = tn2(n5);
        if (t == yn2 || t == Sn2) return !n5.size;
        if (he2(n5)) return !jr2(n5).length;
        for (var e2 in n5) if (F.call(n5, e2)) return false;
        return true;
      }
      function Ip(n5, t) {
        return oe3(n5, t);
      ...
      function pe3(n5) {
        if (!Y(n5) || en2(n5) != qn2) return false;
        var t = Ne(n5);
      ...
      function aa2(n5) {
        if (!n5) return [];
        if (an2(n5)) return or4(n5) ? On2(n5) : un2(n5);
        if (ne3 && n5[ne3]) return gf2(n5[ne3]());
        var t = tn2(n5), e2 = t == yn2 ? qr2 : t == Sn2 ? Se3 : Gt3;
        return e2(n5);
      }
      function Xn2(n5) {
        if (!n5) return n5 === 0 ? n5 : 0;
      ...
      function xn2(n5) {
        if (typeof n5 == "number") return n5;
        if (pn(n5)) return _e3;
        if (K3(n5)) {
          var t = typeof n5.valueOf == "function" ? n5.valueOf() : n5;
          n5 = K3(t) ? t + "" : t;
        }
        if (typeof n5 != "string") return n5 === 0 ? n5 : +n5;
        n5 = Ss3(n5);
        var e2 = _o2.test(n5);
      ...
      var Fp = Ft3(function(n5, t) {
        ...
        for (var e2 in t) F.call(t, e2) && se2(n5, e2, t[e2]);
      ...
      var Gp = L6(function(n5, t) {
        ...
        for (s3 && rn2(t[0], t[1], s3) && (r3 = 1); ++e2 < r3; ) for (var o5 = t[e2], f6 = on2(o5), c6 = -1, l5 = f6.length; ++c6 < l5; ) {
...
`;
        else if (lo2.test(E7)) throw new S5(En2);
...
`) + m4 + `return __p
      ...
      function Md(n5, t, e2) {
        if (n5 = W2(n5), n5 && (e2 || t === i4)) return Ss3(n5);
        if (!n5 || !(t = ln(t))) return n5;
        var r3 = On2(n5), s3 = On2(t), o5 = Os3(r3, s3), f6 = Rs3(r3, s3) + 1;
        return ut2(r3, o5, f6).join("");
      }
      function qd(n5, t, e2) {
        if (n5 = W2(n5), n5 && (e2 || t === i4)) return n5.slice(0, Ts3(n5) + 1);
        if (!n5 || !(t = ln(t))) return n5;
        var r3 = On2(n5), s3 = Rs3(r3, On2(t)) + 1;
        return ut2(r3, 0, s3).join("");
      }
      function Bd(n5, t, e2) {
        if (n5 = W2(n5), n5 && (e2 || t === i4)) return n5.replace(Er2, "");
        if (!n5 || !(t = ln(t))) return n5;
      ...
      function Gd(n5, t) {
        ...
        if (s3 === i4) return l5 + r3;
        if (f6 && (c6 += l5.length - c6), yi2(s3)) {
          if (n5.slice(c6).search(s3)) {
            var v5, _3 = l5;
            for (s3.global || (s3 = Br2(s3.source, W2(Xi3.exec(s3)) + "g")), s3.lastIndex = 0; v5 = s3.exec(_3); ) var m4 = v5.index;
      ...
      function pg(n5, t) {
        if (n5 = R2(n5), n5 < 1 || n5 > kn2) return [];
        var e2 = Hn2, r3 = nn2(n5, Hn2);
        t = x3(t), n5 -= Hn2;
        for (var s3 = Fr3(r3, t); ++e2 < n5; ) t(e2);
        return s3;
      }
      function dg(n5) {
...
var cr3 = (A4, u4) => {
  for (var i4 in u4 || (u4 = {})) Zg.call(u4, i4) && Sa2(A4, i4, u4[i4]);
  if (ya2) for (var i4 of ya2(u4)) Jg.call(u4, i4) && Sa2(A4, i4, u4[i4]);
  return A4;
};
...
var kg = class {
  ...
  getHttpProvider() {
    ...
    if (typeof i4 > "u") throw new Error(`JSON-RPC provider for ${u4} not found`);
    return i4;
  }
  ...
  createHttpProvider(u4, i4) {
    ...
    if (!p5) throw new Error(`No RPC url provided for chainId: ${u4}`);
...
var jg = class {
  ...
  async handleSwitchChain(u4) {
    ...
    if (this.isChainApproved(b5)) this.setDefaultChain(`${b5}`);
    else if (this.namespace.methods.includes("wallet_switchEthereumChain")) await this.client.request({ topic: u4.topic, request: { method: u4.request.method, params: [{ chainId: w5 }] }, chainId: (p5 = this.namespace.chains) == null ? void 0 : p5[0] }), this.setDefaultChain(`${b5}`);
    else throw new Error(`Failed to switch to chain 'eip155:${b5}'. The chain is not approved or the wallet does not support 'wallet_switchEthereumChain' method.`);
    return null;
  }
  isChainApproved(u4) {
...
var hr3 = (A4, u4) => {
  for (var i4 in u4 || (u4 = {})) fv.call(u4, i4) && Da2(A4, i4, u4[i4]);
  if (La2) for (var i4 of La2(u4)) cv.call(u4, i4) && Da2(A4, i4, u4[i4]);
  return A4;
};
...
var lr3 = class _lr {
  ...
  async cleanupPendingPairings(u4 = {}) {
    ...
    if (Er(i4)) {
      for (const p5 of i4) u4.deletePairings ? this.client.core.expirer.set(p5.topic, 0) : await this.client.core.relayer.subscriber.unsubscribe(p5.topic);
  ...
  validateChain(u4) {
    ...
    if (i4 && !Object.keys(this.namespaces || {}).map((D4) => vo(D4)).includes(i4)) throw new Error(`Namespace '${i4}' is not configured. Please call connect() first with namespace config.`);
...
var C4 = class _C {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m3(this.rpc.chains) : m3(this.rpc.optionalChains), this.signer = await hv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s3;
      try {
        const { WalletConnectModal: i4 } = await import("./dist-A27UTJND.js");
        s3 = i4;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-N4A6LXB2.js.map
